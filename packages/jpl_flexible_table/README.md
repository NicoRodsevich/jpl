...
> Este paquete (`jpl_flexible_table`) es un **fork** de [`flexible_table`](https://github.com/peiffer-innovations/flexable_table), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
