...
> Este paquete (`jpl_rest_pubsub`) es un **fork** de [`rest_pubsub`](https://github.com/peiffer-innovations/rest_pubsub), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
