...
> Este paquete (`jpl_ionicons_named`) es un **fork** de [`ionicons_named`](https://github.com/peiffer-innovations/ionicons_named), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
