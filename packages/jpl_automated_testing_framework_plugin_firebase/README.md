...
> Este paquete (`jpl_automated_testing_framework_plugin_firebase`) es un **fork** de [`automated_testing_framework_plugin_firebase`](https://github.com/peiffer-innovations/automated_testing_framework_plugin_firebase), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
