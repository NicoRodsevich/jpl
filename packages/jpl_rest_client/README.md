...
> Este paquete (`jpl_rest_client`) es un **fork** de [`rest_client`](https://github.com/peiffer-innovations/rest_client), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
