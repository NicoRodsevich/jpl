...
> Este paquete (`jpl_font_awesome_flutter_named`) es un **fork** de [`font_awesome_flutter_named`](https://github.com/peiffer-innovations/font_awesome_flutter_named), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
