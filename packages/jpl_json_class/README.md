...
> Este paquete (`jpl_json_class`) es un **fork** de [`json_class`](https://github.com/peiffer-innovations/json_class), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
