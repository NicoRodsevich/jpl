...
> Este paquete (`jpl_json_dynamic_widget_plugin_lottie`) es un **fork** de [`json_dynamic_widget_plugin_lottie`](https://github.com/peiffer-innovations/json_dynamic_widget_plugin_lottie), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
