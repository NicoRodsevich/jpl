...
class JsonMarkdownDecoder {
  ...
  ///
  /// See also:
  /// * [ThemeDecoder.instance.decodeBoxDecoration]
  /// * [ThemeDecoder.instance.decodeEdgeInsetsGeometry]
  /// * [ThemeDecoder.instance.decodeTableBorder]
  /// * [ThemeDecoder.instance.decodeTableColumnWidth]
  /// * [ThemeDecoder.instance.decodeTextStyle]
  /// * [ThemeDecoder.instance.decodeWrapAlignment]
  static MarkdownStyleSheet? decodeMarkdownStyleSheet(
    ...
    if (map is MarkdownStyleSheet) {
      ...
      result = MarkdownStyleSheet(
        a: ThemeDecoder.instance.decodeTextStyle(
          map['a'],
          validate: false,
        ),
        blockSpacing: JsonClass.parseDouble(map['blockSpacing']),
        blockquote: ThemeDecoder.instance.decodeTextStyle(
          map['blockquote'],
          validate: false,
        ),
        blockquoteAlign: ThemeDecoder.instance.decodeWrapAlignment(
              map['blockquoteAlign'],
              validate: false,
            ) ??
            WrapAlignment.start,
        blockquoteDecoration: map['decoration'],
        blockquotePadding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
            map['blockquotePadding'],
            validate: false) as EdgeInsets?,
        checkbox: ThemeDecoder.instance.decodeTextStyle(
          map['checkbox'],
          validate: false,
        ),
        code: ThemeDecoder.instance.decodeTextStyle(
          map['code'],
          validate: false,
        ),
        codeblockAlign: ThemeDecoder.instance
                .decodeWrapAlignment(map['codeblockAlign'], validate: false) ??
            WrapAlignment.start,
        codeblockDecoration: map['codeblockDecoration'],
        codeblockPadding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['codeblockPadding'],
          validate: false,
        ) as EdgeInsets?,
        del: ThemeDecoder.instance.decodeTextStyle(
          map['del'],
          validate: false,
        ),
        em: ThemeDecoder.instance.decodeTextStyle(
          map['em'],
          validate: false,
        ),
        h1: ThemeDecoder.instance.decodeTextStyle(
          map['h1'],
          validate: false,
        ),
        h1Align: ThemeDecoder.instance.decodeWrapAlignment(
              map['h1Align'],
              validate: false,
            ) ??
            WrapAlignment.start,
        h1Padding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['h1Padding'],
          validate: false,
        ) as EdgeInsets?,
        h2: ThemeDecoder.instance.decodeTextStyle(
          map['h2'],
          validate: false,
        ),
        h2Align: ThemeDecoder.instance.decodeWrapAlignment(
              map['h2Align'],
              validate: false,
            ) ??
            WrapAlignment.start,
        h2Padding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['h2Padding'],
          validate: false,
        ) as EdgeInsets?,
        h3: ThemeDecoder.instance.decodeTextStyle(
          map['h3'],
          validate: false,
        ),
        h3Align: ThemeDecoder.instance.decodeWrapAlignment(
              map['h3Align'],
              validate: false,
            ) ??
            WrapAlignment.start,
        h3Padding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['h3Padding'],
          validate: false,
        ) as EdgeInsets?,
        h4: ThemeDecoder.instance.decodeTextStyle(
          map['h4'],
          validate: false,
        ),
        h4Align: ThemeDecoder.instance.decodeWrapAlignment(
              map['h4Align'],
              validate: false,
            ) ??
            WrapAlignment.start,
        h4Padding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['h4Padding'],
          validate: false,
        ) as EdgeInsets?,
        h5: ThemeDecoder.instance.decodeTextStyle(
          map['h5'],
          validate: false,
        ),
        h5Align: ThemeDecoder.instance.decodeWrapAlignment(
              map['h5Align'],
              validate: false,
            ) ??
            WrapAlignment.start,
        h5Padding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['h5Padding'],
          validate: false,
        ) as EdgeInsets?,
        h6: ThemeDecoder.instance.decodeTextStyle(
          map['h6'],
          validate: false,
        ),
        h6Align: ThemeDecoder.instance.decodeWrapAlignment(
              map['h6Align'],
              validate: false,
            ) ??
            WrapAlignment.start,
        h6Padding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['h6Padding'],
          validate: false,
        ) as EdgeInsets?,
        horizontalRuleDecoration: map['horizontalRuleDecoration'],
        img: ThemeDecoder.instance.decodeTextStyle(
          map['img'],
          validate: false,
        ),
        listBullet: ThemeDecoder.instance.decodeTextStyle(
          map['listBullet'],
          validate: false,
        ),
        listBulletPadding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['listBulletPadding'],
          validate: false,
        ) as EdgeInsets?,
        listIndent: JsonClass.parseDouble(map['listIndent']),
        orderedListAlign: ThemeDecoder.instance.decodeWrapAlignment(
              map['orderedListAlign'],
              validate: false,
            ) ??
            WrapAlignment.start,
        p: ThemeDecoder.instance.decodeTextStyle(
          map['p'],
          validate: false,
        ),
        pPadding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['pPadding'],
          validate: false,
        ) as EdgeInsets?,
        strong: ThemeDecoder.instance.decodeTextStyle(
          map['strong'],
          validate: false,
        ),
        superscriptFontFeatureTag: map['superscriptFontFeatureTag'],
        tableBody: ThemeDecoder.instance.decodeTextStyle(
          map['tableBody'],
          validate: false,
        ),
        ...
        tableCellsDecoration: ThemeDecoder.instance.decodeBoxDecoration(
          map['tableCellsDecoration'],
          validate: false,
        ),
        tableCellsPadding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
        ...
        tableHead: ThemeDecoder.instance.decodeTextStyle(
          map['tableHead'],
          validate: false,
        ),
        tableHeadAlign: ThemeDecoder.instance.decodeTextAlign(
          map['tableHeadAlign'],
          validate: false,
        ),
        tablePadding: ThemeDecoder.instance.decodeEdgeInsetsGeometry(
          map['tablePadding'],
          validate: false,
        ) as EdgeInsets?,
        ...
        textAlign: ThemeDecoder.instance.decodeWrapAlignment(
              map['textAlign'],
              validate: false,
            ) ??
            WrapAlignment.start,
        textScaler: map['textScaler'],
        unorderedListAlign: ThemeDecoder.instance.decodeWrapAlignment(
              map['textAlign'],
              validate: false,
            ) ??
            WrapAlignment.start,
