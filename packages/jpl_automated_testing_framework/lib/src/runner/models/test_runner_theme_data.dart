...
class TestRunnerThemeData implements JsonClass {
  ...
  static TestRunnerThemeData? fromDynamic(dynamic map) {
    ...
    if (map != null) {
      result = TestRunnerThemeData(
        runnerOverlayColor:
            ThemeDecoder.instance.decodeColor(map['runnerOverlayColor'])!,
        ...
        statusBackgroundColor:
            ThemeDecoder.instance.decodeColor(map['statusBackgroundColor'])!,
        statusErrorColor:
            ThemeDecoder.instance.decodeColor(map['statusErrorColor'])!,
        statusOpacity: JsonClass.parseDouble(map['statusOpacity'])!,
        statusProgressColor:
            ThemeDecoder.instance.decodeColor(map['statusProgressColor'])!,
        statusSuccessColor:
            ThemeDecoder.instance.decodeColor(map['statusSuccessColor'])!,
        statusTextColor:
            ThemeDecoder.instance.decodeColor(map['statusTextColor'])!,
      );
    }
  ...
  Map<String, dynamic> toJson() => {
        'runnerOverlayColor':
            ThemeEncoder.instance.encodeColor(runnerOverlayColor),
        'showRunnerStatus': showRunnerStatus,
        'showStepText': showStepText,
        'statusAlignment': statusAlignment.toString(),
        'statusBackgroundColor':
            ThemeEncoder.instance.encodeColor(statusBackgroundColor),
        'statusErrorColor': ThemeEncoder.instance.encodeColor(statusErrorColor),
        'statusOpacity': statusOpacity,
        'statusProgressColor':
            ThemeEncoder.instance.encodeColor(statusProgressColor),
        'statusSuccessColor':
            ThemeEncoder.instance.encodeColor(statusSuccessColor),
        'statusTextColor': ThemeEncoder.instance.encodeColor(statusTextColor),
      };
}
