...
class RemoveVariableForm extends TestStepForm {
  const RemoveVariableForm();

  @override
  bool get supportsMinified => true;

  @override
  TranslationEntry get title => TestStepTranslations.atf_title_remove_variable;
    ...
    return Column(
      ...
      children: <Widget>[
        if (minify != true)
          buildHelpSection(
            context,
            TestStepTranslations.atf_help_remove_variable,
            minify: minify,
          ),
        buildValuesSection(
          context,
