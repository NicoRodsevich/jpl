  ...
  static SetDateVariableStep fromDynamic(dynamic map) {
    ...
    if (map == null) {
      ...
      result = SetDateVariableStep(
        ...
        format: map['format'],
        offsetDays: JsonClass.maybeParseInt(map['offsetDays']) ?? 0,
        offsetHours: JsonClass.maybeParseInt(map['offsetHours']) ?? 0,
        offsetMinutes: JsonClass.maybeParseInt(map['offsetMinutes']) ?? 0,
        offsetSeconds: JsonClass.maybeParseInt(map['offsetSeconds']) ?? 0,
