...
> Este paquete (`jpl_automated_testing_framework_server_websocket`) es un **fork** de [`automated_testing_framework_server_websocket`](https://github.com/peiffer-innovations/automated_testing_framework_server_websocket), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
