...
// `IconData` is a `final` class as of newer Flutter and can no longer be
// extended. Expose a factory that builds an `IconData` instead, preserving the
// named-argument convenience API.
class IconDataCodec {
  const IconDataCodec._();

  static material.IconData create({
