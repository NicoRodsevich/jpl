...
abstract class _ThemeEncoderFunctions {
  ...
  Map<String, dynamic>? encodeSegmentedButtonThemeData(
    ...
    if (value != null) {
      ...
      result = {
        'selectedIcon':
            icon is Icon ? ThemeEncoder.instance.encodeIcon(icon) : null,
  ...
  /// }
  /// ```
  Map<String, dynamic>? encodeWidgetStatePropertyIcon(
    WidgetStateProperty<Icon?>? value,
  ) {
    Map<String, dynamic>? result;

    if (value != null) {
      result = {
        'disabled': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.disabled}),
        ),
        'dragged': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.dragged}),
        ),
        'empty': ThemeEncoder.instance.encodeIcon(value.resolve({})),
        'error': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.error}),
        ),
        'focused': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.focused}),
        ),
        'hovered': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.hovered}),
        ),
        'pressed': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.pressed}),
        ),
        'scrolledUnder': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.selected}),
        ),
        'selected': ThemeEncoder.instance.encodeIcon(
          value.resolve({WidgetState.selected}),
        ),
      };
    }
  ...
  /// Encodes the [FloatingActionButtonAnimator] to a [String].  Supported
  /// values are:
  ///  * `noAnimation`
  ///  * `scaling`
  ...
  /// Encodes the [FloatingActionButtonLocation] to a [String].  Supported
  /// values are:
  ///  * `centerDocked`
  ///  * `centerFloat`
  ///  * `centerTop`
  ...
  String? encodeFloatingActionButtonLocation(
    ...
    if (value != null) {
      const values = <FloatingActionButtonLocation, String>{
  ...
  /// Encodes the [TextScaler] to a [String].  Supported values are:
  ///  * `noScaling`
