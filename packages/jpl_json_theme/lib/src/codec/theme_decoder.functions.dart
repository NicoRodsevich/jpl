...
abstract class _ThemeDecoderFunctions {
          ...
          switch (type) {
            ...
            case 'horizontal':
              result = BorderRadius.horizontal(
                left: ThemeDecoder.instance.decodeRadius(
                      value['left'],
                      validate: false,
                    ) ??
                    Radius.zero,
                right: ThemeDecoder.instance.decodeRadius(
                      value['right'],
                      validate: false,
                    ) ??
                    Radius.zero,
            ...
            case 'only':
              result = BorderRadius.only(
                bottomLeft: ThemeDecoder.instance.decodeRadius(
                      value['bottomLeft'],
                      validate: false,
                    ) ??
                    Radius.zero,
                bottomRight: ThemeDecoder.instance.decodeRadius(
                      value['bottomRight'],
                      validate: false,
                    ) ??
                    Radius.zero,
                topLeft: ThemeDecoder.instance.decodeRadius(
                      value['topLeft'],
                      validate: false,
                    ) ??
                    Radius.zero,
                topRight: ThemeDecoder.instance.decodeRadius(
                      value['topRight'],
                      validate: false,
                    ) ??
                    Radius.zero,
            ...
            case 'vertical':
              result = BorderRadius.vertical(
                bottom: ThemeDecoder.instance.decodeRadius(
                      value['bottom'],
                      validate: false,
                    ) ??
                    Radius.zero,
                top: ThemeDecoder.instance.decodeRadius(
                      value['top'],
                      validate: false,
                    ) ??
                    Radius.zero,
        ...
        switch (type) {
          case 'linear':
            result = LinearGradient(
              begin: decodeAlignment(value['begin'], validate: false) ??
              ...
              end: decodeAlignment(value['end'], validate: false) ??
          ...
          case 'radial':
            result = RadialGradient(
              center: decodeAlignment(value['center'], validate: false) ??
                  Alignment.center,
  ...
  PageTransitionsTheme? decodePageTransitionsTheme(
    ...
    if (value is PageTransitionsTheme) {
      ...
      value['builders']?.forEach(
        (key, value) => builders[ThemeDecoder.instance.decodeTargetPlatform(
          key,
          validate: false,
    ...
    if (value is SystemUiOverlayStyle) {
      ...
      result = SystemUiOverlayStyle(
        ...
        systemNavigationBarIconBrightness:
            ThemeDecoder.instance.decodeBrightness(
    ...
    if (value is FloatingActionButtonLocation) {
      ...
      switch (value) {
        ...
        case 'centerTop':
          ...
          break;
        case 'endContained':
          result = FloatingActionButtonLocation.endContained;
          break;
        case 'endDocked':
  ...
  SliderComponentShape? decodeSliderComponentShape(
    ...
    if (value is SliderComponentShape) {
      ...
      switch (value) {
        ...
        default:
          throw Exception(
            'Unknown value: "$value" for: SliderComponentShape',
          );
      }
    }
  ...
  SliderTickMarkShape? decodeSliderTickMarkShape(
    ...
    if (value is SliderTickMarkShape) {
      ...
      switch (value) {
        ...
        default:
          throw Exception(
            'Unknown value: "$value" for: SliderTickMarkShape',
          );
      }
    }
  ...
  ///  * `noScaling`
  ///
  /// A `Map` of the form `{"textScaleFactor": "<double>"}` is also supported
  /// and will produce a linear [TextScaler].
  TextScaler? decodeTextScaler(dynamic value, {bool validate = true}) {
    ...
    if (value is TextScaler) {
      ...
      result = TextScaler.linear(
        JsonClass.parseDouble(value['textScaleFactor']),
      );
    } else if (value != null) {
      assert(
        SchemaValidator.validate(
