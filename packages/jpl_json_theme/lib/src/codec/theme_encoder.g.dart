...
// Dart SDK: 3.12.2 (stable) (Tue Jun 9 01:11:39 2026 -0700) on "macos_arm64"
// Flutter SDK:
//   Flutter 3.44.4 • channel stable • https://github.com/flutter/flutter.git
//   Framework • revision ad70ec4617 (6 days ago) • 2026-06-24 11:07:06 -0700
//   Engine • hash 700aebeca4c0e610f109a3979ee3e71b69d666bc (revision a10d8ac38d) (6 days ago) • 2026-06-23 23:09:55.000Z
...
class ThemeEncoder extends _ThemeEncoder {
  ...
  Map<String, dynamic>? encodeAppBarThemeData(AppBarThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'actionsIconTheme':
          ThemeEncoder.instance.encodeIconThemeData(value.actionsIconTheme),
      'actionsPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.actionsPadding),
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
      'centerTitle': value.centerTitle,
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'foregroundColor':
          ThemeEncoder.instance.encodeColor(value.foregroundColor),
      'iconTheme': ThemeEncoder.instance.encodeIconThemeData(value.iconTheme),
      'leadingWidth':
          value.leadingWidth == double.infinity ? null : value.leadingWidth,
      ...
      'surfaceTintColor':
          ThemeEncoder.instance.encodeColor(value.surfaceTintColor),
      'systemOverlayStyle': ThemeEncoder.instance
          .encodeSystemUiOverlayStyle(value.systemOverlayStyle),
      'titleSpacing':
          value.titleSpacing == double.infinity ? null : value.titleSpacing,
      'titleTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.titleTextStyle),
      'toolbarHeight':
          value.toolbarHeight == double.infinity ? null : value.toolbarHeight,
      'toolbarTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.toolbarTextStyle),
    });
  }
  ...
  Map<String, dynamic>? encodeBadgeThemeData(BadgeThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'alignment':
          ThemeEncoder.instance.encodeAlignmentGeometry(value.alignment),
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
  ...
  Map<String, dynamic>? encodeBorderSide(BorderSide? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'strokeAlign':
          value.strokeAlign == double.infinity ? null : value.strokeAlign,
  ...
  Map<String, dynamic>? encodeBottomNavigationBarThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'mouseCursor': ThemeEncoder.instance
          .encodeWidgetStatePropertyMouseCursor(value.mouseCursor),
      'selectedIconTheme':
          ThemeEncoder.instance.encodeIconThemeData(value.selectedIconTheme),
      'selectedItemColor':
          ThemeEncoder.instance.encodeColor(value.selectedItemColor),
      'selectedLabelStyle':
          ThemeEncoder.instance.encodeTextStyle(value.selectedLabelStyle),
      ...
      'unselectedIconTheme':
          ThemeEncoder.instance.encodeIconThemeData(value.unselectedIconTheme),
      'unselectedItemColor':
          ThemeEncoder.instance.encodeColor(value.unselectedItemColor),
      'unselectedLabelStyle':
          ThemeEncoder.instance.encodeTextStyle(value.unselectedLabelStyle),
    });
  }
  ...
  Map<String, dynamic>? encodeBottomSheetThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'constraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.constraints),
      'dragHandleColor':
          ThemeEncoder.instance.encodeColor(value.dragHandleColor),
      'dragHandleSize': ThemeEncoder.instance.encodeSize(value.dragHandleSize),
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'modalBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.modalBackgroundColor),
      'modalBarrierColor':
          ThemeEncoder.instance.encodeColor(value.modalBarrierColor),
      'modalElevation':
          value.modalElevation == double.infinity ? null : value.modalElevation,
      'shadowColor': ThemeEncoder.instance.encodeColor(value.shadowColor),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
  ...
  Map<String, dynamic>? encodeBoxDecoration(BoxDecoration? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'backgroundBlendMode':
          ThemeEncoder.instance.encodeBlendMode(value.backgroundBlendMode),
      'border': ThemeEncoder.instance.encodeBoxBorder(value.border),
      'borderRadius':
          ThemeEncoder.instance.encodeBorderRadiusGeometry(value.borderRadius),
  ...
  Map<String, dynamic>? encodeBoxShadow(BoxShadow? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'blurRadius':
          value.blurRadius == double.infinity ? null : value.blurRadius,
      'blurStyle': ThemeEncoder.instance.encodeBlurStyle(value.blurStyle),
      'color': ThemeEncoder.instance.encodeColor(value.color),
      'offset': ThemeEncoder.instance.encodeOffset(value.offset),
      'spreadRadius':
          value.spreadRadius == double.infinity ? null : value.spreadRadius,
    });
  }
  ...
  Map<String, dynamic>? encodeButtonStyle(ButtonStyle? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'backgroundColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.backgroundColor),
      'elevation': ThemeEncoder.instance
          .encodeWidgetStatePropertyDouble(value.elevation),
      'enableFeedback': value.enableFeedback,
      'fixedSize':
          ThemeEncoder.instance.encodeWidgetStatePropertySize(value.fixedSize),
      'foregroundColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.foregroundColor),
      'iconAlignment':
          ThemeEncoder.instance.encodeIconAlignment(value.iconAlignment),
      'iconColor':
          ThemeEncoder.instance.encodeWidgetStatePropertyColor(value.iconColor),
      'iconSize':
          ThemeEncoder.instance.encodeWidgetStatePropertyDouble(value.iconSize),
      'maximumSize': ThemeEncoder.instance
          .encodeWidgetStatePropertySize(value.maximumSize),
      'minimumSize': ThemeEncoder.instance
          .encodeWidgetStatePropertySize(value.minimumSize),
      'mouseCursor': ThemeEncoder.instance
          .encodeWidgetStatePropertyMouseCursor(value.mouseCursor),
      'overlayColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.overlayColor),
      'padding': ThemeEncoder.instance
          .encodeWidgetStatePropertyEdgeInsetsGeometry(value.padding),
      'shadowColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.shadowColor),
      'shape': ThemeEncoder.instance
          .encodeWidgetStatePropertyOutlinedBorder(value.shape),
      'side':
          ThemeEncoder.instance.encodeWidgetStatePropertyBorderSide(value.side),
      'splashFactory': ThemeEncoder.instance
          .encodeInteractiveInkFeatureFactory(value.splashFactory),
      'surfaceTintColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.surfaceTintColor),
      'tapTargetSize': ThemeEncoder.instance
          .encodeMaterialTapTargetSize(value.tapTargetSize),
      'textStyle': ThemeEncoder.instance
          .encodeWidgetStatePropertyTextStyle(value.textStyle),
      'visualDensity':
          ThemeEncoder.instance.encodeVisualDensity(value.visualDensity),
    });
  }
  ...
  Map<String, dynamic>? encodeButtonThemeData(ButtonThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'height': value.height == double.infinity ? null : value.height,
      'layoutBehavior': ThemeEncoder.instance
          .encodeButtonBarLayoutBehavior(value.layoutBehavior),
      'minWidth': value.minWidth == double.infinity ? null : value.minWidth,
      'padding': ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.padding),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
  ...
  Map<String, dynamic>? encodeCarouselViewThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'itemClipBehavior':
          ThemeEncoder.instance.encodeClip(value.itemClipBehavior),
      'overlayColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.overlayColor),
  ...
  Map<String, dynamic>? encodeCheckboxThemeData(CheckboxThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'checkColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.checkColor),
      'fillColor':
          ThemeEncoder.instance.encodeWidgetStatePropertyColor(value.fillColor),
      ...
      'splashRadius':
          value.splashRadius == double.infinity ? null : value.splashRadius,
      'visualDensity':
          ThemeEncoder.instance.encodeVisualDensity(value.visualDensity),
    });
  }
  ...
  Map<String, dynamic>? encodeChipThemeData(ChipThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'avatarBoxConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.avatarBoxConstraints),
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
      ...
      'color':
          ThemeEncoder.instance.encodeWidgetStatePropertyColor(value.color),
      'deleteIconBoxConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.deleteIconBoxConstraints),
      'deleteIconColor':
          ThemeEncoder.instance.encodeColor(value.deleteIconColor),
      'disabledColor': ThemeEncoder.instance.encodeColor(value.disabledColor),
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'iconTheme': ThemeEncoder.instance.encodeIconThemeData(value.iconTheme),
      'labelPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.labelPadding),
      'labelStyle': ThemeEncoder.instance.encodeTextStyle(value.labelStyle),
      'padding': ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.padding),
      'pressElevation':
          value.pressElevation == double.infinity ? null : value.pressElevation,
      'secondaryLabelStyle':
          ThemeEncoder.instance.encodeTextStyle(value.secondaryLabelStyle),
      'secondarySelectedColor':
          ThemeEncoder.instance.encodeColor(value.secondarySelectedColor),
      'selectedColor': ThemeEncoder.instance.encodeColor(value.selectedColor),
      'selectedShadowColor':
          ThemeEncoder.instance.encodeColor(value.selectedShadowColor),
      'shadowColor': ThemeEncoder.instance.encodeColor(value.shadowColor),
      'shape': ThemeEncoder.instance.encodeOutlinedBorder(value.shape),
  ...
  Map<String, dynamic>? encodeColorScheme(ColorScheme? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'onErrorContainer':
          ThemeEncoder.instance.encodeColor(value.onErrorContainer),
      'onInverseSurface':
          ThemeEncoder.instance.encodeColor(value.onInverseSurface),
      'onPrimary': ThemeEncoder.instance.encodeColor(value.onPrimary),
      'onPrimaryContainer':
          ThemeEncoder.instance.encodeColor(value.onPrimaryContainer),
      'onPrimaryFixed': ThemeEncoder.instance.encodeColor(value.onPrimaryFixed),
      'onPrimaryFixedVariant':
          ThemeEncoder.instance.encodeColor(value.onPrimaryFixedVariant),
      'onSecondary': ThemeEncoder.instance.encodeColor(value.onSecondary),
      'onSecondaryContainer':
          ThemeEncoder.instance.encodeColor(value.onSecondaryContainer),
      'onSecondaryFixed':
          ThemeEncoder.instance.encodeColor(value.onSecondaryFixed),
      'onSecondaryFixedVariant':
          ThemeEncoder.instance.encodeColor(value.onSecondaryFixedVariant),
      'onSurface': ThemeEncoder.instance.encodeColor(value.onSurface),
      'onSurfaceVariant':
          ThemeEncoder.instance.encodeColor(value.onSurfaceVariant),
      'onTertiary': ThemeEncoder.instance.encodeColor(value.onTertiary),
      'onTertiaryContainer':
          ThemeEncoder.instance.encodeColor(value.onTertiaryContainer),
      'onTertiaryFixed':
          ThemeEncoder.instance.encodeColor(value.onTertiaryFixed),
      'onTertiaryFixedVariant':
          ThemeEncoder.instance.encodeColor(value.onTertiaryFixedVariant),
      ...
      'surfaceContainer':
          ThemeEncoder.instance.encodeColor(value.surfaceContainer),
      'surfaceContainerHigh':
          ThemeEncoder.instance.encodeColor(value.surfaceContainerHigh),
      'surfaceContainerHighest':
          ThemeEncoder.instance.encodeColor(value.surfaceContainerHighest),
      'surfaceContainerLow':
          ThemeEncoder.instance.encodeColor(value.surfaceContainerLow),
      'surfaceContainerLowest':
          ThemeEncoder.instance.encodeColor(value.surfaceContainerLowest),
      ...
      'tertiaryContainer':
          ThemeEncoder.instance.encodeColor(value.tertiaryContainer),
      'tertiaryFixed': ThemeEncoder.instance.encodeColor(value.tertiaryFixed),
      'tertiaryFixedDim':
          ThemeEncoder.instance.encodeColor(value.tertiaryFixedDim),
    });
  }
  ...
  Map<String, dynamic>? encodeCupertinoTextThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      'actionSmallTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.actionSmallTextStyle),
      'actionTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.actionTextStyle),
      'dateTimePickerTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.dateTimePickerTextStyle),
      'navActionTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.navActionTextStyle),
      'navLargeTitleTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.navLargeTitleTextStyle),
      'navTitleTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.navTitleTextStyle),
      'pickerTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.pickerTextStyle),
      'tabLabelTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.tabLabelTextStyle),
      'textStyle': ThemeEncoder.instance.encodeTextStyle(value.textStyle),
    });
  }
  ...
  Map<String, dynamic>? encodeCupertinoThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'barBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.barBackgroundColor),
      'brightness': ThemeEncoder.instance.encodeBrightness(value.brightness),
      'primaryColor': ThemeEncoder.instance.encodeColor(value.primaryColor),
      'primaryContrastingColor':
          ThemeEncoder.instance.encodeColor(value.primaryContrastingColor),
      'scaffoldBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.scaffoldBackgroundColor),
      'selectionHandleColor':
          ThemeEncoder.instance.encodeColor(value.selectionHandleColor),
      'textTheme':
          ThemeEncoder.instance.encodeCupertinoTextThemeData(value.textTheme),
    });
  }
  ...
  Map<String, dynamic>? encodeDataTableThemeData(DataTableThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'columnSpacing':
          value.columnSpacing == double.infinity ? null : value.columnSpacing,
      'dataRowColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.dataRowColor),
      ...
      'dataTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.dataTextStyle),
      ...
      'headingRowAlignment': ThemeEncoder.instance
          .encodeMainAxisAlignment(value.headingRowAlignment),
      'headingRowColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.headingRowColor),
      'headingRowHeight': value.headingRowHeight == double.infinity
          ? null
          : value.headingRowHeight,
      'headingTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.headingTextStyle),
  ...
  Map<String, dynamic>? encodeDatePickerThemeData(DatePickerThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
      'cancelButtonStyle':
          ThemeEncoder.instance.encodeButtonStyle(value.cancelButtonStyle),
      'confirmButtonStyle':
          ThemeEncoder.instance.encodeButtonStyle(value.confirmButtonStyle),
      ...
      'dayOverlayColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.dayOverlayColor),
      'dayShape': ThemeEncoder.instance
          .encodeWidgetStatePropertyOutlinedBorder(value.dayShape),
      ...
      'headerBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.headerBackgroundColor),
      'headerForegroundColor':
          ThemeEncoder.instance.encodeColor(value.headerForegroundColor),
      'headerHeadlineStyle':
          ThemeEncoder.instance.encodeTextStyle(value.headerHeadlineStyle),
      'headerHelpStyle':
          ThemeEncoder.instance.encodeTextStyle(value.headerHelpStyle),
      ...
      'rangePickerBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.rangePickerBackgroundColor),
      'rangePickerElevation': value.rangePickerElevation == double.infinity
          ? null
          : value.rangePickerElevation,
      'rangePickerHeaderBackgroundColor': ThemeEncoder.instance
          .encodeColor(value.rangePickerHeaderBackgroundColor),
      'rangePickerHeaderForegroundColor': ThemeEncoder.instance
          .encodeColor(value.rangePickerHeaderForegroundColor),
      'rangePickerHeaderHeadlineStyle': ThemeEncoder.instance
          .encodeTextStyle(value.rangePickerHeaderHeadlineStyle),
      'rangePickerHeaderHelpStyle': ThemeEncoder.instance
          .encodeTextStyle(value.rangePickerHeaderHelpStyle),
      'rangePickerShadowColor':
          ThemeEncoder.instance.encodeColor(value.rangePickerShadowColor),
      'rangePickerShape':
          ThemeEncoder.instance.encodeShapeBorder(value.rangePickerShape),
      'rangePickerSurfaceTintColor':
          ThemeEncoder.instance.encodeColor(value.rangePickerSurfaceTintColor),
      'rangeSelectionBackgroundColor': ThemeEncoder.instance
          .encodeColor(value.rangeSelectionBackgroundColor),
      ...
      'subHeaderForegroundColor':
          ThemeEncoder.instance.encodeColor(value.subHeaderForegroundColor),
      'surfaceTintColor':
          ThemeEncoder.instance.encodeColor(value.surfaceTintColor),
      ...
      'toggleButtonTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.toggleButtonTextStyle),
      ...
      'yearOverlayColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.yearOverlayColor),
  ...
  Map<String, dynamic>? encodeDecorationImage(DecorationImage? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'filterQuality':
          ThemeEncoder.instance.encodeFilterQuality(value.filterQuality),
  ...
  Map<String, dynamic>? encodeDialogThemeData(DialogThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'constraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.constraints),
      'contentTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.contentTextStyle),
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'iconColor': ThemeEncoder.instance.encodeColor(value.iconColor),
      'insetPadding':
          ThemeEncoder.instance.encodeEdgeInsets(value.insetPadding),
      'shadowColor': ThemeEncoder.instance.encodeColor(value.shadowColor),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
      'surfaceTintColor':
          ThemeEncoder.instance.encodeColor(value.surfaceTintColor),
  ...
  Map<String, dynamic>? encodeExpansionTileThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
      'childrenPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.childrenPadding),
      'clipBehavior': ThemeEncoder.instance.encodeClip(value.clipBehavior),
      'collapsedBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.collapsedBackgroundColor),
      'collapsedIconColor':
          ThemeEncoder.instance.encodeColor(value.collapsedIconColor),
      'collapsedShape':
          ThemeEncoder.instance.encodeShapeBorder(value.collapsedShape),
      'collapsedTextColor':
          ThemeEncoder.instance.encodeColor(value.collapsedTextColor),
      'expandedAlignment': ThemeEncoder.instance
          .encodeAlignmentGeometry(value.expandedAlignment),
      'expansionAnimationStyle': ThemeEncoder.instance
          .encodeAnimationStyle(value.expansionAnimationStyle),
      'iconColor': ThemeEncoder.instance.encodeColor(value.iconColor),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
      'textColor': ThemeEncoder.instance.encodeColor(value.textColor),
      'tilePadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.tilePadding),
    });
  }
  ...
  Map<String, dynamic>? encodeFloatingActionButtonThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'extendedPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.extendedPadding),
      'extendedSizeConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.extendedSizeConstraints),
      'extendedTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.extendedTextStyle),
      'focusColor': ThemeEncoder.instance.encodeColor(value.focusColor),
      'focusElevation':
          value.focusElevation == double.infinity ? null : value.focusElevation,
      'foregroundColor':
          ThemeEncoder.instance.encodeColor(value.foregroundColor),
      ...
      'hoverElevation':
          value.hoverElevation == double.infinity ? null : value.hoverElevation,
      'iconSize': value.iconSize == double.infinity ? null : value.iconSize,
      'largeSizeConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.largeSizeConstraints),
      'mouseCursor': ThemeEncoder.instance
          .encodeWidgetStatePropertyMouseCursor(value.mouseCursor),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
      'sizeConstraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.sizeConstraints),
      'smallSizeConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.smallSizeConstraints),
  ...
  Map<String, dynamic>? encodeIcon(Icon? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'opticalSize':
          value.opticalSize == double.infinity ? null : value.opticalSize,
      ...
      'textDirection':
          ThemeEncoder.instance.encodeTextDirection(value.textDirection),
  ...
  Map<String, dynamic>? encodeInputDecorationThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      'activeIndicatorBorder':
          ThemeEncoder.instance.encodeBorderSide(value.activeIndicatorBorder),
      'alignLabelWithHint': value.alignLabelWithHint,
      'border': ThemeEncoder.instance.encodeInputBorder(value.border),
      'constraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.constraints),
      'contentPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.contentPadding),
      'counterStyle': ThemeEncoder.instance.encodeTextStyle(value.counterStyle),
      'disabledBorder':
          ThemeEncoder.instance.encodeInputBorder(value.disabledBorder),
      'enabledBorder':
          ThemeEncoder.instance.encodeInputBorder(value.enabledBorder),
      ...
      'floatingLabelStyle':
          ThemeEncoder.instance.encodeTextStyle(value.floatingLabelStyle),
      'focusColor': ThemeEncoder.instance.encodeColor(value.focusColor),
      'focusedBorder':
          ThemeEncoder.instance.encodeInputBorder(value.focusedBorder),
      'focusedErrorBorder':
          ThemeEncoder.instance.encodeInputBorder(value.focusedErrorBorder),
      ...
      'labelStyle': ThemeEncoder.instance.encodeTextStyle(value.labelStyle),
      'outlineBorder':
          ThemeEncoder.instance.encodeBorderSide(value.outlineBorder),
      'prefixIconColor':
          ThemeEncoder.instance.encodeColor(value.prefixIconColor),
      'prefixIconConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.prefixIconConstraints),
      'prefixStyle': ThemeEncoder.instance.encodeTextStyle(value.prefixStyle),
      'suffixIconColor':
          ThemeEncoder.instance.encodeColor(value.suffixIconColor),
      'suffixIconConstraints': ThemeEncoder.instance
          .encodeBoxConstraints(value.suffixIconConstraints),
  ...
  Map<String, dynamic>? encodeListTileThemeData(ListTileThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'contentPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.contentPadding),
      'controlAffinity': ThemeEncoder.instance
          .encodeListTileControlAffinity(value.controlAffinity),
      'dense': value.dense,
      'enableFeedback': value.enableFeedback,
      ...
      'leadingAndTrailingTextStyle': ThemeEncoder.instance
          .encodeTextStyle(value.leadingAndTrailingTextStyle),
      'minLeadingWidth': value.minLeadingWidth == double.infinity
          ? null
          : value.minLeadingWidth,
      'minTileHeight':
          value.minTileHeight == double.infinity ? null : value.minTileHeight,
      ...
      'selectedColor': ThemeEncoder.instance.encodeColor(value.selectedColor),
      'selectedTileColor':
          ThemeEncoder.instance.encodeColor(value.selectedTileColor),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
      'style': ThemeEncoder.instance.encodeListTileStyle(value.style),
      'subtitleTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.subtitleTextStyle),
      'textColor': ThemeEncoder.instance.encodeColor(value.textColor),
      'tileColor': ThemeEncoder.instance.encodeColor(value.tileColor),
      'titleAlignment': ThemeEncoder.instance
          .encodeListTileTitleAlignment(value.titleAlignment),
      'titleTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.titleTextStyle),
      'visualDensity':
          ThemeEncoder.instance.encodeVisualDensity(value.visualDensity),
  ...
  Map<String, dynamic>? encodeMaterialBannerThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'leadingPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.leadingPadding),
      'padding': ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.padding),
      'shadowColor': ThemeEncoder.instance.encodeColor(value.shadowColor),
      'surfaceTintColor':
          ThemeEncoder.instance.encodeColor(value.surfaceTintColor),
  ...
  Map<String, dynamic>? encodeNavigationBarThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'height': value.height == double.infinity ? null : value.height,
      'iconTheme': ThemeEncoder.instance
          .encodeWidgetStatePropertyIconThemeData(value.iconTheme),
      'indicatorColor': ThemeEncoder.instance.encodeColor(value.indicatorColor),
      'indicatorShape':
          ThemeEncoder.instance.encodeShapeBorder(value.indicatorShape),
  ...
  Map<String, dynamic>? encodeNavigationDrawerThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'surfaceTintColor':
          ThemeEncoder.instance.encodeColor(value.surfaceTintColor),
      'tileHeight':
          value.tileHeight == double.infinity ? null : value.tileHeight,
    });
  }
  ...
  Map<String, dynamic>? encodeNavigationRailThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'groupAlignment':
          value.groupAlignment == double.infinity ? null : value.groupAlignment,
      'indicatorColor': ThemeEncoder.instance.encodeColor(value.indicatorColor),
      'indicatorShape':
          ThemeEncoder.instance.encodeShapeBorder(value.indicatorShape),
      'labelType':
          ThemeEncoder.instance.encodeNavigationRailLabelType(value.labelType),
      ...
      'selectedLabelTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.selectedLabelTextStyle),
      'unselectedIconTheme':
          ThemeEncoder.instance.encodeIconThemeData(value.unselectedIconTheme),
      'unselectedLabelTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.unselectedLabelTextStyle),
  ...
  Map<String, dynamic>? encodePopupMenuThemeData(PopupMenuThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'labelTextStyle': ThemeEncoder.instance
          .encodeWidgetStatePropertyTextStyle(value.labelTextStyle),
      'menuPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.menuPadding),
      'mouseCursor': ThemeEncoder.instance
          .encodeWidgetStatePropertyMouseCursor(value.mouseCursor),
  ...
  Map<String, dynamic>? encodeProgressIndicatorThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      'borderRadius':
          ThemeEncoder.instance.encodeBorderRadiusGeometry(value.borderRadius),
      'circularTrackColor':
          ThemeEncoder.instance.encodeColor(value.circularTrackColor),
      'circularTrackPadding': ThemeEncoder.instance
          .encodeEdgeInsetsGeometry(value.circularTrackPadding),
      'color': ThemeEncoder.instance.encodeColor(value.color),
      'constraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.constraints),
      ...
      'linearTrackColor':
          ThemeEncoder.instance.encodeColor(value.linearTrackColor),
      'refreshBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.refreshBackgroundColor),
      'stopIndicatorColor':
          ThemeEncoder.instance.encodeColor(value.stopIndicatorColor),
      ...
      'strokeWidth':
          value.strokeWidth == double.infinity ? null : value.strokeWidth,
  ...
  Map<String, dynamic>? encodeRadioThemeData(RadioThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'fillColor':
          ThemeEncoder.instance.encodeWidgetStatePropertyColor(value.fillColor),
      'innerRadius': ThemeEncoder.instance
          .encodeWidgetStatePropertyDouble(value.innerRadius),
      'materialTapTargetSize': ThemeEncoder.instance
          .encodeMaterialTapTargetSize(value.materialTapTargetSize),
      'mouseCursor': ThemeEncoder.instance
          .encodeWidgetStatePropertyMouseCursor(value.mouseCursor),
  ...
  Map<String, dynamic>? encodeScrollbarThemeData(ScrollbarThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'mainAxisMargin':
          value.mainAxisMargin == double.infinity ? null : value.mainAxisMargin,
      'minThumbLength':
          value.minThumbLength == double.infinity ? null : value.minThumbLength,
      'radius': ThemeEncoder.instance.encodeRadius(value.radius),
      'thickness': ThemeEncoder.instance
          .encodeWidgetStatePropertyDouble(value.thickness),
      'thumbColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.thumbColor),
      'thumbVisibility': ThemeEncoder.instance
          .encodeWidgetStatePropertyBool(value.thumbVisibility),
      'trackBorderColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.trackBorderColor),
      'trackColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.trackColor),
      'trackVisibility': ThemeEncoder.instance
          .encodeWidgetStatePropertyBool(value.trackVisibility),
    });
  }
  ...
  Map<String, dynamic>? encodeSearchBarThemeData(SearchBarThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'elevation': ThemeEncoder.instance
          .encodeWidgetStatePropertyDouble(value.elevation),
      'hintStyle': ThemeEncoder.instance
          .encodeWidgetStatePropertyTextStyle(value.hintStyle),
      'overlayColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.overlayColor),
      'padding': ThemeEncoder.instance
          .encodeWidgetStatePropertyEdgeInsetsGeometry(value.padding),
      ...
      'surfaceTintColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.surfaceTintColor),
      'textCapitalization': ThemeEncoder.instance
          .encodeTextCapitalization(value.textCapitalization),
      'textStyle': ThemeEncoder.instance
          .encodeWidgetStatePropertyTextStyle(value.textStyle),
    });
  }
  ...
  Map<String, dynamic>? encodeSearchViewThemeData(SearchViewThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
      'barPadding':
          ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.barPadding),
      'constraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.constraints),
      'dividerColor': ThemeEncoder.instance.encodeColor(value.dividerColor),
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'headerHeight':
          value.headerHeight == double.infinity ? null : value.headerHeight,
      'headerHintStyle':
          ThemeEncoder.instance.encodeTextStyle(value.headerHintStyle),
      'headerTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.headerTextStyle),
      'padding': ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.padding),
      'shape': ThemeEncoder.instance.encodeOutlinedBorder(value.shape),
  ...
  Map<String, dynamic>? encodeSliderThemeData(SliderThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'activeTickMarkColor':
          ThemeEncoder.instance.encodeColor(value.activeTickMarkColor),
      'activeTrackColor':
          ThemeEncoder.instance.encodeColor(value.activeTrackColor),
      'allowedInteraction': ThemeEncoder.instance
          .encodeSliderInteraction(value.allowedInteraction),
      'disabledActiveTickMarkColor':
          ThemeEncoder.instance.encodeColor(value.disabledActiveTickMarkColor),
      'disabledActiveTrackColor':
          ThemeEncoder.instance.encodeColor(value.disabledActiveTrackColor),
      'disabledInactiveTickMarkColor': ThemeEncoder.instance
          .encodeColor(value.disabledInactiveTickMarkColor),
      'disabledInactiveTrackColor':
          ThemeEncoder.instance.encodeColor(value.disabledInactiveTrackColor),
      'disabledSecondaryActiveTrackColor': ThemeEncoder.instance
          .encodeColor(value.disabledSecondaryActiveTrackColor),
      'disabledThumbColor':
          ThemeEncoder.instance.encodeColor(value.disabledThumbColor),
      'inactiveTickMarkColor':
          ThemeEncoder.instance.encodeColor(value.inactiveTickMarkColor),
      'inactiveTrackColor':
          ThemeEncoder.instance.encodeColor(value.inactiveTrackColor),
      ...
      'overlappingShapeStrokeColor':
          ThemeEncoder.instance.encodeColor(value.overlappingShapeStrokeColor),
      'overlayColor': ThemeEncoder.instance.encodeColor(value.overlayColor),
      'overlayShape':
          ThemeEncoder.instance.encodeSliderComponentShape(value.overlayShape),
      'padding': ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.padding),
      'rangeThumbShape': ThemeEncoder.instance
          .encodeRangeSliderThumbShape(value.rangeThumbShape),
      'rangeTickMarkShape': ThemeEncoder.instance
          .encodeRangeSliderTickMarkShape(value.rangeTickMarkShape),
      'rangeTrackShape': ThemeEncoder.instance
          .encodeRangeSliderTrackShape(value.rangeTrackShape),
      'rangeValueIndicatorShape': ThemeEncoder.instance
          .encodeRangeSliderValueIndicatorShape(value.rangeValueIndicatorShape),
      'secondaryActiveTrackColor':
          ThemeEncoder.instance.encodeColor(value.secondaryActiveTrackColor),
      'showValueIndicator': ThemeEncoder.instance
          .encodeShowValueIndicator(value.showValueIndicator),
      'thumbColor': ThemeEncoder.instance.encodeColor(value.thumbColor),
      'thumbShape':
          ThemeEncoder.instance.encodeSliderComponentShape(value.thumbShape),
      'thumbSize':
          ThemeEncoder.instance.encodeWidgetStatePropertySize(value.thumbSize),
      'tickMarkShape':
          ThemeEncoder.instance.encodeSliderTickMarkShape(value.tickMarkShape),
      'trackGap': value.trackGap == double.infinity ? null : value.trackGap,
      'trackHeight':
          value.trackHeight == double.infinity ? null : value.trackHeight,
      'trackShape':
          ThemeEncoder.instance.encodeSliderTrackShape(value.trackShape),
      'valueIndicatorColor':
          ThemeEncoder.instance.encodeColor(value.valueIndicatorColor),
      'valueIndicatorShape': ThemeEncoder.instance
          .encodeSliderComponentShape(value.valueIndicatorShape),
      'valueIndicatorStrokeColor':
          ThemeEncoder.instance.encodeColor(value.valueIndicatorStrokeColor),
      'valueIndicatorTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.valueIndicatorTextStyle),
    });
  }
  ...
  Map<String, dynamic>? encodeSnackBarThemeData(SnackBarThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'actionBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.actionBackgroundColor),
      'actionOverflowThreshold':
          value.actionOverflowThreshold == double.infinity
              ? null
              : value.actionOverflowThreshold,
      'actionTextColor':
          ThemeEncoder.instance.encodeColor(value.actionTextColor),
      'backgroundColor':
          ThemeEncoder.instance.encodeColor(value.backgroundColor),
      ...
      'contentTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.contentTextStyle),
      'disabledActionBackgroundColor': ThemeEncoder.instance
          .encodeColor(value.disabledActionBackgroundColor),
      'disabledActionTextColor':
          ThemeEncoder.instance.encodeColor(value.disabledActionTextColor),
      'dismissDirection':
          ThemeEncoder.instance.encodeDismissDirection(value.dismissDirection),
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'insetPadding':
          ThemeEncoder.instance.encodeEdgeInsets(value.insetPadding),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
  ...
  Map<String, dynamic>? encodeSwitchThemeData(SwitchThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'thumbColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.thumbColor),
      'thumbIcon':
          ThemeEncoder.instance.encodeWidgetStatePropertyIcon(value.thumbIcon),
      'trackColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.trackColor),
      'trackOutlineColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.trackOutlineColor),
  ...
  Map<String, dynamic>? encodeTabBarThemeData(TabBarThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'dividerColor': ThemeEncoder.instance.encodeColor(value.dividerColor),
      'dividerHeight':
          value.dividerHeight == double.infinity ? null : value.dividerHeight,
      'indicator': ThemeEncoder.instance.encodeDecoration(value.indicator),
      'indicatorAnimation': ThemeEncoder.instance
          .encodeTabIndicatorAnimation(value.indicatorAnimation),
      'indicatorColor': ThemeEncoder.instance.encodeColor(value.indicatorColor),
      'indicatorSize':
          ThemeEncoder.instance.encodeTabBarIndicatorSize(value.indicatorSize),
      ...
      'overlayColor': ThemeEncoder.instance
          .encodeWidgetStatePropertyColor(value.overlayColor),
      'splashBorderRadius':
          ThemeEncoder.instance.encodeBorderRadius(value.splashBorderRadius),
      'splashFactory': ThemeEncoder.instance
          .encodeInteractiveInkFeatureFactory(value.splashFactory),
      'tabAlignment':
          ThemeEncoder.instance.encodeTabAlignment(value.tabAlignment),
      'textScaler': ThemeEncoder.instance.encodeTextScaler(value.textScaler),
      'unselectedLabelColor':
          ThemeEncoder.instance.encodeColor(value.unselectedLabelColor),
      'unselectedLabelStyle':
          ThemeEncoder.instance.encodeTextStyle(value.unselectedLabelStyle),
    });
  }
  ...
  Map<String, dynamic>? encodeTableBorder(TableBorder? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'borderRadius':
          ThemeEncoder.instance.encodeBorderRadius(value.borderRadius),
      'bottom': ThemeEncoder.instance.encodeBorderSide(value.bottom),
      'horizontalInside':
          ThemeEncoder.instance.encodeBorderSide(value.horizontalInside),
      ...
      'verticalInside':
          ThemeEncoder.instance.encodeBorderSide(value.verticalInside),
    });
  }
  ...
  String? encodeTextAlignVertical(TextAlignVertical? value) {
    ...
    String? result;
    if (value == TextAlignVertical.bottom) {
      result = 'bottom';
    } else if (value == TextAlignVertical.center) {
      result = 'center';
    } else if (value == TextAlignVertical.top) {
      result = 'top';
    }
  ...
  String? encodeTextInputType(TextInputType? value) {
    ...
    String? result;
    if (value.index >= 0 && value.index < names.length) {
      result = names[value.index];
    }
  ...
  Map<String, dynamic>? encodeTextStyle(TextStyle? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'debugLabel': value.debugLabel,
      'decoration':
          ThemeEncoder.instance.encodeTextDecoration(value.decoration),
      'decorationColor':
          ThemeEncoder.instance.encodeColor(value.decorationColor),
      'decorationStyle': ThemeEncoder.instance
          .encodeTextDecorationStyle(value.decorationStyle),
      ...
      'leadingDistribution': ThemeEncoder.instance
          .encodeTextLeadingDistribution(value.leadingDistribution),
      'letterSpacing':
          value.letterSpacing == double.infinity ? null : value.letterSpacing,
      'locale': ThemeEncoder.instance.encodeLocale(value.locale),
      ...
      'textBaseline':
          ThemeEncoder.instance.encodeTextBaseline(value.textBaseline),
      'wordSpacing':
          value.wordSpacing == double.infinity ? null : value.wordSpacing,
    });
  }
  ...
  Map<String, dynamic>? encodeTextTheme(TextTheme? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'displayMedium':
          ThemeEncoder.instance.encodeTextStyle(value.displayMedium),
      'displaySmall': ThemeEncoder.instance.encodeTextStyle(value.displaySmall),
      'headlineLarge':
          ThemeEncoder.instance.encodeTextStyle(value.headlineLarge),
      'headlineMedium':
          ThemeEncoder.instance.encodeTextStyle(value.headlineMedium),
      'headlineSmall':
          ThemeEncoder.instance.encodeTextStyle(value.headlineSmall),
  ...
  Map<String, dynamic>? encodeThemeData(ThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      'actionIconTheme': ThemeEncoder.instance
          .encodeActionIconThemeData(value.actionIconTheme),
      'appBarTheme':
          ThemeEncoder.instance.encodeAppBarThemeData(value.appBarTheme),
      'applyElevationOverlayColor': value.applyElevationOverlayColor,
      'badgeTheme':
          ThemeEncoder.instance.encodeBadgeThemeData(value.badgeTheme),
      'bannerTheme': ThemeEncoder.instance
          .encodeMaterialBannerThemeData(value.bannerTheme),
      'bottomAppBarTheme': ThemeEncoder.instance
          .encodeBottomAppBarThemeData(value.bottomAppBarTheme),
      'bottomNavigationBarTheme': ThemeEncoder.instance
          .encodeBottomNavigationBarThemeData(value.bottomNavigationBarTheme),
      'bottomSheetTheme': ThemeEncoder.instance
          .encodeBottomSheetThemeData(value.bottomSheetTheme),
      'brightness': ThemeEncoder.instance.encodeBrightness(value.brightness),
      'buttonTheme':
          ThemeEncoder.instance.encodeButtonThemeData(value.buttonTheme),
      ...
      'carouselViewTheme': ThemeEncoder.instance
          .encodeCarouselViewThemeData(value.carouselViewTheme),
      'checkboxTheme':
          ThemeEncoder.instance.encodeCheckboxThemeData(value.checkboxTheme),
      ...
      'dataTableTheme':
          ThemeEncoder.instance.encodeDataTableThemeData(value.dataTableTheme),
      'datePickerTheme': ThemeEncoder.instance
          .encodeDatePickerThemeData(value.datePickerTheme),
      'dialogTheme':
          ThemeEncoder.instance.encodeDialogThemeData(value.dialogTheme),
      'disabledColor': ThemeEncoder.instance.encodeColor(value.disabledColor),
      'dividerColor': ThemeEncoder.instance.encodeColor(value.dividerColor),
      'dividerTheme':
          ThemeEncoder.instance.encodeDividerThemeData(value.dividerTheme),
      'drawerTheme':
          ThemeEncoder.instance.encodeDrawerThemeData(value.drawerTheme),
      'dropdownMenuTheme': ThemeEncoder.instance
          .encodeDropdownMenuThemeData(value.dropdownMenuTheme),
      'elevatedButtonTheme': ThemeEncoder.instance
          .encodeElevatedButtonThemeData(value.elevatedButtonTheme),
      'expansionTileTheme': ThemeEncoder.instance
          .encodeExpansionTileThemeData(value.expansionTileTheme),
      'filledButtonTheme': ThemeEncoder.instance
          .encodeFilledButtonThemeData(value.filledButtonTheme),
      ...
      'hoverColor': ThemeEncoder.instance.encodeColor(value.hoverColor),
      'iconButtonTheme': ThemeEncoder.instance
          .encodeIconButtonThemeData(value.iconButtonTheme),
      'iconTheme': ThemeEncoder.instance.encodeIconThemeData(value.iconTheme),
      'inputDecorationTheme': ThemeEncoder.instance
          .encodeInputDecorationThemeData(value.inputDecorationTheme),
      'listTileTheme':
          ThemeEncoder.instance.encodeListTileThemeData(value.listTileTheme),
      'materialTapTargetSize': ThemeEncoder.instance
          .encodeMaterialTapTargetSize(value.materialTapTargetSize),
      'menuBarTheme':
          ThemeEncoder.instance.encodeMenuBarThemeData(value.menuBarTheme),
      'menuButtonTheme': ThemeEncoder.instance
          .encodeMenuButtonThemeData(value.menuButtonTheme),
      'menuTheme': ThemeEncoder.instance.encodeMenuThemeData(value.menuTheme),
      'navigationBarTheme': ThemeEncoder.instance
          .encodeNavigationBarThemeData(value.navigationBarTheme),
      ...
      'pageTransitionsTheme': ThemeEncoder.instance
          .encodePageTransitionsTheme(value.pageTransitionsTheme),
      'platform': ThemeEncoder.instance.encodeTargetPlatform(value.platform),
      'popupMenuTheme':
          ThemeEncoder.instance.encodePopupMenuThemeData(value.popupMenuTheme),
      'primaryColor': ThemeEncoder.instance.encodeColor(value.primaryColor),
      'primaryColorDark':
          ThemeEncoder.instance.encodeColor(value.primaryColorDark),
      'primaryColorLight':
          ThemeEncoder.instance.encodeColor(value.primaryColorLight),
      'primaryIconTheme':
          ThemeEncoder.instance.encodeIconThemeData(value.primaryIconTheme),
      'primaryTextTheme':
          ThemeEncoder.instance.encodeTextTheme(value.primaryTextTheme),
      'progressIndicatorTheme': ThemeEncoder.instance
          .encodeProgressIndicatorThemeData(value.progressIndicatorTheme),
      'radioTheme':
          ThemeEncoder.instance.encodeRadioThemeData(value.radioTheme),
      'scaffoldBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.scaffoldBackgroundColor),
      'scrollbarTheme':
          ThemeEncoder.instance.encodeScrollbarThemeData(value.scrollbarTheme),
      'searchBarTheme':
          ThemeEncoder.instance.encodeSearchBarThemeData(value.searchBarTheme),
      'searchViewTheme': ThemeEncoder.instance
          .encodeSearchViewThemeData(value.searchViewTheme),
      'secondaryHeaderColor':
          ThemeEncoder.instance.encodeColor(value.secondaryHeaderColor),
      'segmentedButtonTheme': ThemeEncoder.instance
          .encodeSegmentedButtonThemeData(value.segmentedButtonTheme),
      'shadowColor': ThemeEncoder.instance.encodeColor(value.shadowColor),
      'sliderTheme':
          ThemeEncoder.instance.encodeSliderThemeData(value.sliderTheme),
      'snackBarTheme':
          ThemeEncoder.instance.encodeSnackBarThemeData(value.snackBarTheme),
      'splashColor': ThemeEncoder.instance.encodeColor(value.splashColor),
      'splashFactory': ThemeEncoder.instance
          .encodeInteractiveInkFeatureFactory(value.splashFactory),
      'switchTheme':
          ThemeEncoder.instance.encodeSwitchThemeData(value.switchTheme),
      'tabBarTheme':
          ThemeEncoder.instance.encodeTabBarThemeData(value.tabBarTheme),
      'textButtonTheme': ThemeEncoder.instance
          .encodeTextButtonThemeData(value.textButtonTheme),
      'textSelectionTheme': ThemeEncoder.instance
          .encodeTextSelectionThemeData(value.textSelectionTheme),
      'textTheme': ThemeEncoder.instance.encodeTextTheme(value.textTheme),
      'timePickerTheme': ThemeEncoder.instance
          .encodeTimePickerThemeData(value.timePickerTheme),
      'toggleButtonsTheme': ThemeEncoder.instance
          .encodeToggleButtonsThemeData(value.toggleButtonsTheme),
      'tooltipTheme':
          ThemeEncoder.instance.encodeTooltipThemeData(value.tooltipTheme),
      'typography': ThemeEncoder.instance.encodeTypography(value.typography),
      'unselectedWidgetColor':
          ThemeEncoder.instance.encodeColor(value.unselectedWidgetColor),
  ...
  Map<String, dynamic>? encodeTimePickerThemeData(TimePickerThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'confirmButtonStyle':
          ThemeEncoder.instance.encodeButtonStyle(value.confirmButtonStyle),
      'dayPeriodBorderSide':
          ThemeEncoder.instance.encodeBorderSide(value.dayPeriodBorderSide),
      'dayPeriodColor': ThemeEncoder.instance.encodeColor(value.dayPeriodColor),
      'dayPeriodShape':
          ThemeEncoder.instance.encodeOutlinedBorder(value.dayPeriodShape),
      'dayPeriodTextColor':
          ThemeEncoder.instance.encodeColor(value.dayPeriodTextColor),
      'dayPeriodTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.dayPeriodTextStyle),
      'dialBackgroundColor':
          ThemeEncoder.instance.encodeColor(value.dialBackgroundColor),
      ...
      'dialTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.dialTextStyle),
      'elevation': value.elevation == double.infinity ? null : value.elevation,
      'entryModeIconColor':
          ThemeEncoder.instance.encodeColor(value.entryModeIconColor),
      'helpTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.helpTextStyle),
      'hourMinuteColor':
          ThemeEncoder.instance.encodeColor(value.hourMinuteColor),
      'hourMinuteShape':
          ThemeEncoder.instance.encodeShapeBorder(value.hourMinuteShape),
      'hourMinuteTextColor':
          ThemeEncoder.instance.encodeColor(value.hourMinuteTextColor),
      'hourMinuteTextStyle':
          ThemeEncoder.instance.encodeTextStyle(value.hourMinuteTextStyle),
      'inputDecorationTheme': ThemeEncoder.instance
          .encodeInputDecorationThemeData(value.inputDecorationTheme),
      'padding': ThemeEncoder.instance.encodeEdgeInsetsGeometry(value.padding),
      'shape': ThemeEncoder.instance.encodeShapeBorder(value.shape),
  ...
  Map<String, dynamic>? encodeToggleButtonsThemeData(
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'borderRadius':
          ThemeEncoder.instance.encodeBorderRadius(value.borderRadius),
      'borderWidth':
          value.borderWidth == double.infinity ? null : value.borderWidth,
      'color': ThemeEncoder.instance.encodeColor(value.color),
      'constraints':
          ThemeEncoder.instance.encodeBoxConstraints(value.constraints),
      'disabledBorderColor':
          ThemeEncoder.instance.encodeColor(value.disabledBorderColor),
      'disabledColor': ThemeEncoder.instance.encodeColor(value.disabledColor),
      'fillColor': ThemeEncoder.instance.encodeColor(value.fillColor),
      'focusColor': ThemeEncoder.instance.encodeColor(value.focusColor),
      'highlightColor': ThemeEncoder.instance.encodeColor(value.highlightColor),
      'hoverColor': ThemeEncoder.instance.encodeColor(value.hoverColor),
      'selectedBorderColor':
          ThemeEncoder.instance.encodeColor(value.selectedBorderColor),
      'selectedColor': ThemeEncoder.instance.encodeColor(value.selectedColor),
      'splashColor': ThemeEncoder.instance.encodeColor(value.splashColor),
      'textStyle': ThemeEncoder.instance.encodeTextStyle(value.textStyle),
    });
  ...
  Map<String, dynamic>? encodeTooltipThemeData(TooltipThemeData? value) {
    ...
    return _stripDynamicNull(<String, dynamic>{
      ...
      'textStyle': ThemeEncoder.instance.encodeTextStyle(value.textStyle),
      'triggerMode':
          ThemeEncoder.instance.encodeTooltipTriggerMode(value.triggerMode),
      'verticalOffset':
          value.verticalOffset == double.infinity ? null : value.verticalOffset,
