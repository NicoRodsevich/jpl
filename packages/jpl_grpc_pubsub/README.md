...
> Este paquete (`jpl_grpc_pubsub`) es un **fork** de [`grpc_pubsub`](https://github.com/peiffer-innovations/grpc_pubsub), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
