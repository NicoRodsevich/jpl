...
> Este paquete (`jpl_json_dynamic_widget_plugin_js`) es un **fork** de [`json_dynamic_widget_plugin_js`](https://github.com/peiffer-innovations/json_dynamic_widget_plugin_js), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
