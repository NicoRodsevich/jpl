...
> Este paquete (`jpl_json_dynamic_widget_plugin_rive`) es un **fork** de [`json_dynamic_widget_plugin_rive`](https://github.com/peiffer-innovations/json_dynamic_widget_plugin_rive), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
