...
> Este paquete (`jpl_json_dynamic_widget_plugin_expressions`) es un **fork** de [`json_dynamic_widget_plugin_expressions`](https://github.com/peiffer-innovations/json_dynamic_widget_plugin_expressions), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
