    ...
    if (map == null) {
      ...
      result = TestReport._internal(
        ...
        endTime: DateTime.fromMillisecondsSinceEpoch(
          JsonClass.maybeParseInt(map['endTime']) ?? 0,
        ),
        id: id ?? map['id'],
        images: JsonClass.maybeFromDynamicList(
        ...
        startTime: DateTime.fromMillisecondsSinceEpoch(
          JsonClass.maybeParseInt(map['startTime']) ?? 0,
        ),
        steps: JsonClass.maybeFromDynamicList(
          map['steps'],
          (entry) => TestReportStep.fromDynamic(entry),
        ),
        suiteName: map['suiteName'],
        version: JsonClass.maybeParseInt(map['version']) ?? 0,
      );
    }
