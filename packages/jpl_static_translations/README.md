...
> Este paquete (`jpl_static_translations`) es un **fork** de [`static_translations`](https://github.com/peiffer-innovations/static_translations), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
