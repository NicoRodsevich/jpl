...
> Este paquete (`jpl_dynamic_widget_annotation`) es un **fork** de [`dynamic_widget_annotation`](https://github.com/peiffer-innovations/json_dynamic_widget), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
