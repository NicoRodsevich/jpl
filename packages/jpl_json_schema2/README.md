...
> Este paquete (`jpl_json_schema2`) es un **fork** de [`json_schema2`](https://github.com/peiffer-innovations/json_schema2), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
