...
> Este paquete (`jpl_dynamic_service`) es un **fork** de [`dynamic_service`](https://github.com/peiffer-innovations/dynamic_service), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
