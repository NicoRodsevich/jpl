...
> Este paquete (`jpl_three_x_plus_1`) es un **fork** de [`three_x_plus_1`](https://github.com/peiffer-innovations/three_x_plus_1), originalmente creado por Jeff Peiffer y **archivado** (read-only) junto con toda la org [`peiffer-innovations`](https://github.com/peiffer-innovations).
>
